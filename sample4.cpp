...
void add_student()
{
    ...
    cin.getline(temp.StudentID, 50);
    cout<<"Enter Surname: ";
    cin.getline(temp.Surname, 20);
    cout<<"Enter tudent's First Name: ";
    cin.getline(temp.FirstName, 20);
    cout<<"Enter Student's Birth Date: ";
    cin.getline(temp.BirthDate, 50);
    cout<<"Enter Sex: ";
    cin.getline(temp.Sex, 5);
